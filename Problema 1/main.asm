...
tratar_centenas:
			...
			IEQ		designa_D				; se igual a 500, atribuimos 500
...
menor_500:
			...
			IEQ		designa_CD				; se igual, atribuimos 400
			...
			IEQ		designa_CCC				; se igual, atribuimos 300
...
designa_C:									; 100
			...
			MOV		#0x0043, @R6			; colocamos C na resposta, levando o ponteiro sempre a diante
			INC		R6
...
designa_CC:									; 200
			...
			MOV		#0x0043, @R6			; colocamos CC na resposta, levando o ponteiro sempre a diante
			INC		R6
			MOV		#0x0043, @R6
			INC		R6
...
designa_CCC:								; 300
			...
			MOV		#0x0043, @R6			; colocamos CCC na resposta, levando o ponteiro sempre a diante
			INC		R6
			MOV		#0x0043, @R6
			INC		R6
			MOV		#0x0043, @R6
...
designa_CD:									; 400
			...
			MOV		#0x0043, @R6			; colocamos CD na resposta, levando o ponteiro sempre a diante
			INC		R6
			MOV		#0x0044, @R6
			INC		R6
...
designa_D:									; 500
			...
			MOV		#0x0044, @R6			; colocamos D na resposta, levando o ponteiro sempre a diante
			INC		R6
...
designa_DC:									; 600
			...
			MOV		#0x0044, @R6			; colocamos DC na resposta, levando o ponteiro sempre a diante
			INC		R6
			MOV		#0x0043, @R6
			INC		R6
...
designa_DCC:								; 700
			...
			MOV		#0x0044, @R6			; colocamos DCC na resposta, levando o ponteiro sempre a diante
			INC		R6
			MOV		#0x0043, @R6
			INC		R6
			MOV		#0x0043, @R6
...
designa_CM:									; 900
			...
			MOV		#0x0043, @R6			; colocamos CM na resposta, levando o ponteiro sempre a diante
			INC		R6
			MOV		#0x004D, @R6
			INC		R6
...
tratar_dezenas:
			...
			IEQ		designa_L				; se igual a 50, atribuimos 50
...
menor_50:
			...
			IEQ		designa_XL				; se igual, atribuimos 40
			...
			IEQ		designa_XXX				; se igual, atribuimos 30
...
designa_X:
			...
			MOV		#0x0058, @R6			; colocamos X na resposta, levando o ponteiro sempre a diante
			INC		R6
...
designa_XX:
			...
			MOV		#0x0058, @R6			; colocamos XX na resposta, levando o ponteiro sempre a diante
			INC		R6
			MOV		#0x0058, @R6
			INC		R6
...
designa_XXX:
			...
			MOV		#0x0058, @R6			; colocamos XXX na resposta, levando o ponteiro sempre a diante
			INC		R6
			MOV		#0x0058, @R6
			INC		R6
			MOV		#0x0058, @R6
...
designa_XL:
			...
			MOV		#0x0058, @R6			; colocamos XL na resposta, levando o ponteiro sempre a diante
			INC		R6
			MOV		#0x004C, @R6
			INC		R6
...
designa_L:
			...
			MOV		#0x004C, @R6			; colocamos L na resposta, levando o ponteiro sempre a diante
			INC		R6
...
designa_LX:
			...
			MOV		#0x004C, @R6			; colocamos LX na resposta, levando o ponteiro sempre a diante
			INC		R6
			MOV		#0x0058, @R6
			INC		R6
...
designa_LXX:
			...
			MOV		#0x004C, @R6			; colocamos LXX na resposta, levando o ponteiro sempre a diante
			INC		R6
			MOV		#0x0058, @R6
			INC		R6
			MOV		#0x0058, @R6
...
designa_LXXX:
			...
			MOV		#0x004C, @R6			; colocamos LXXX na resposta, levando o ponteiro sempre a diante
			INC		R6
			MOV		#0x0058, @R6
			INC		R6
			MOV		#0x0058, @R6
...
designa_XC:
			...
			MOV		#0x0058, @R6			; colocamos LX na resposta, levando o ponteiro sempre a diante
			INC		R6
			MOV		#0x0043, @R6
			INC		R6
...
designa_IX:
			...
			MOV		#0x0049, @R6			; atribuimos XI na resposta
			INC		R6
			MOV		#0x0058, @R6
			INC		R6
...
designa_VIII:
			...
			MOV		#0x0056, @R6			; atribuimos VIII na resposta
			INC		R6
			MOV		#0x0049, @R6
			INC		R6
			MOV		#0x0049, @R6
...
designa_VII:
			...
			MOV		#0x0056, @R6			; atribuimos VII na resposta
			INC		R6
			MOV		#0x0049, @R6
			INC		R6
			MOV		#0x0049, @R6
...
designa_VI:
			...
			MOV		#0x0056, @R6			; atribuimos VI na resposta
			INC		R6
			MOV		#0x0049, @R6
			INC		R6
...
designa_V:
			...
			MOV		#0x0056, @R6			; atribuimos V na resposta
			INC		R6
...
designa_IV:
			...
			MOV		#0x0049, @R6			; atribuimos IV na resposta
			INC		R6
			MOV		#0x0056, @R6
			INC		R6
...
designa_III:
			...
			MOV		#0x0049, @R6			; atribuimos III na resposta
			INC		R6
			MOV		#0x0049, @R6
			INC		R6
			MOV		#0x0049, @R6
...
designa_II:
			...
			MOV		#0x0049, @R6			; atribuimos II na resposta
			INC		R6
			MOV		#0x0049, @R6
			INC		R6
...
designa_I:
			...
			MOV		#0x0049, @R6			; atribuimos I na resposta
			INC		R6
...
designa_fim:
			...
			MOV		#0x0000, @R6			; final da respota
